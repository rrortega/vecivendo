...
export const BottomNav = ({ className = "" }) => {
    ...
    const { showOfflineMessage } = useConnection();
        ...
        <AnimatePresence>
            {!showOfflineMessage && (
                <motion.div
                    ...
                    className={`fixed bottom-0 left-0 right-0 z-[100] bg-surface/80 backdrop-blur-lg border-t border-border shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] pb-safe md:hidden ${className}`}
                >
