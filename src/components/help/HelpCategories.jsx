        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
            <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-medium transition-all border ${activeCategory === 'all'
                    ...
                    : 'bg-surface text-gray-600 dark:text-white border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
            >
                Todos
            </button>
            {categories.map((category) => (
                <button
                    ...
                    className={`px-6 py-2 rounded-full text-sm font-medium transition-all border ${activeCategory === category.id
                        ? 'border-primary text-primary bg-primary/5 shadow-sm'
                        : 'bg-surface text-gray-400 dark:text-white border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700'
                        }`}
                >
                    {category.name}
                </button>
